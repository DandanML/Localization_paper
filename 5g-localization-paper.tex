...
Simulaiton shows that the proposed solution can achieve 10~m accuary for mixed LoS and NLoS enviorment. And the proposed algorithm can also work even with only the information from one base station. 
...
take the corresponding reported beam indices. Then, pre-processing is done to separate the data based on the cell ID and whehther it is best beam index, or second/third/fourth best beam index.
