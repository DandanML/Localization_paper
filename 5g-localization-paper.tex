...
\begin{itemize}
	...
	\item channel model: this describes the probability of observing the %given measurement report at a specific location as illustrated in section ~\ref{sec:channel-model}.
\end{itemize}
